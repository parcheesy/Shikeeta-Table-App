...
class GuestsControllerTest < ActionController::TestCase
  ...
  test "should create guest" do
    assert_difference('Guest.count') do
      post :create, guest: { firstname: @guest.firstname, lastname: @guest.lastname, table: @guest.table }
    end
  ...
  test "should update guest" do
    patch :update, id: @guest, guest: { firstname: @guest.firstname, lastname: @guest.lastname, table: @guest.table }
    assert_redirected_to guest_path(assigns(:guest))
  end
